                            ...
                            <tbody>
                                <?php if(!empty($mesas)):?>
                                    ...
                                    <?php foreach($mesas as $mesa):?>
                                        <tr>
                                            <?php $data = $mesa->id."*".$mesa->numero."*".$mesa->area_id;?>
                                            <td><?php echo $mesa->numero;?></td>
                                            <td><?php echo getArea($mesa->area_id)->nombre;?></td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if($mesa->estado == 1):?>
                                                    <button type="button" class="btn btn-warning btn-edit-mesa" data-toggle="modal" data-target="#modal-default" value="<?php echo $data;?>">
